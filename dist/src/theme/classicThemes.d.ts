...
export declare const CLASSIC_THEME_SKINS: {
    ...
    readonly win3x: readonly ["default"];
    readonly winxp: readonly ["default"];
    readonly cde: readonly ["default"];
    readonly macos9: readonly ["default"];
    readonly dos: readonly ["default"];
};
...
export declare function getDefaultSkinForTheme(theme: ClassicTheme): ClassicSkin;
export declare function isSkinValidForTheme(theme: ClassicTheme, skin: string): boolean;
